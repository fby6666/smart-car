...
int SecondOrderLagFilter_Motor(int16_t value)
{
...
int SecondOrderLagFilter_L(int16_t value)
{
    static float last_value,last_2_value;
    value=0.2f*value+0.4f*last_value+0.4f*last_2_value;     //�����ͺ��˲�
    last_2_value=last_value;
...
int SecondOrderLagFilter_R(int16_t value)
{
    static float last_value,last_2_value;
    value=0.2f*value+0.4f*last_value+0.4f*last_2_value;     //�����ͺ��˲�
    last_2_value=last_value;
...
void Get_Encoder()
{
	motor_l.Encoder=(short) __HAL_TIM_GET_COUNTER(&htim4);     //保存编码器计数器的值
	motor_r.Encoder=(short) __HAL_TIM_GET_COUNTER(&htim3);
